...
public class TrapDoor_CannotClose : MonoBehaviour
{
    ...
    public SpriteRenderer doorSpriteRenderer;//门的贴图渲染器
    ...
    private void Awake()
    {
        ...
        {
            doorSpriteRenderer.sprite = closedDoorSprite;//初始贴图为关闭的门
        }
    ...
    public virtual void OpenDoor()
    {
        ...
        isOpen = true;//设置为打开状态
        doorSpriteRenderer.sprite = openDoorSprite;//切换贴图为打开的门
